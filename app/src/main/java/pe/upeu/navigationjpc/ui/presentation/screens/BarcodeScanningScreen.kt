...
import pe.edu.upeu.navegacionjpc.ui.presentation.component.BarcodeScanningAnalyzer
...
fun BarcodeScanningScreen(navController: NavController) {
    ...
    when (cameraPermissionState.status) {
        ...
        is PermissionStatus.Denied -> {
            val isPermanentlyDenied = !(cameraPermissionState.status as PermissionStatus.Denied).shouldShowRationale
            ...
            if (isPermanentlyDenied) {
                Toast.makeText(context, "Permiso denegado permanentemente. Actívalo en configuración.", Toast.LENGTH_LONG).show()
            }
        }
    }
}
